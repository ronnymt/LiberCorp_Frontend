...
// Fuentes auto-hospedadas (antes: <link> a fonts.googleapis.com/gstatic.com
// en cada pagina) -- mismo font-family/pesos, ahora empaquetados con Vite en
// vez de depender de un CDN externo (ver ZAP: cerraba el hallazgo de SRI
// faltante, ademas de sacar 2 dominios del CSP). Solo los pesos que el
// template realmente usa (grep sobre production/*.html).
