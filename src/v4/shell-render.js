...
// Sistema LibreNMS — NAV real de la app, organizada en modulos con submenu
// colapsable (Clientes/Facturacion/Reporteria/Administracion) para poder
// seguir agregando paginas dentro de cada uno sin reacomodar todo de nuevo.
// Dashboard queda suelto (sin modulo "Red/Monitoreo" todavia) hasta que haya
// un segundo item real que justifique agruparlo -- decision explicita del
// usuario para no crear modulos vacios de un solo item.
export const NAV = [
  {
    label: 'General',
    items: [
      { key: 'dashboard', href: 'index.html', text: 'Inicio', icon: 'dashboard' },
      {
        icon: 'users',
        text: 'Clientes',
        children: [
          { key: 'clientes', href: 'clientes.html', text: 'Listado de clientes' }
          // futuro: Mapa de clientes, Tipos de servicio, Tarifas por puerto
        ]
      },
      {
        icon: 'price',
        text: 'Facturacion',
        children: [
          { key: 'facturacion', href: 'facturacion.html', text: 'Boletas' },
          { key: 'transacciones', href: 'transacciones.html', text: 'Transacciones' },
          { key: 'estadisticas-facturacion', href: 'estadisticas-facturacion.html', text: 'Estadisticas' }
          // futuro: Cuentas bancarias, Tipo de cambio
        ]
      },
      {
        icon: 'mail',
        text: 'Mensajeria',
        children: [
          { key: 'editor-mensajes', href: 'editor-mensajes.html', text: 'Editor de mensajes' },
          { key: 'mensajes-enviados', href: 'mensajes-enviados.html', text: 'Mensajes enviados' },
          { key: 'descargar-graficas', href: 'descargar-graficas.html', text: 'Descargar graficas' }
        ]
      },
      {
        icon: 'receipt',
        text: 'Reporteria',
        children: [
          { key: 'reportes-general', href: 'reportes-general.html', text: 'Reportes Generales' },
          { key: 'reportes', href: 'reportes.html', text: 'Reporte de caidas' },
          { key: 'estado-pagos', href: 'estado-pagos.html', text: 'Estado de pagos' }
          // futuro: mas tipos de reporte (inventario, etc.)
        ]
      },
      {
        icon: 'settings',
        ...
        children: [
          { key: 'configuracion', href: 'configuracion.html', text: 'Datos generales' },
          { key: 'vencimientos', href: 'vencimientos.html', text: 'Vencimientos' },
          { key: 'cuentas-bancarias', href: 'cuentas-bancarias.html', text: 'Cuentas' },
          { key: 'tipo-cambio', href: 'tipo-cambio.html', text: 'Tipo de cambio' },
          { key: 'integraciones', href: 'integraciones.html', text: 'Integraciones' },
          { key: 'backups', href: 'backups.html', text: 'Backups' }
        ]
      },
      {
        icon: 'profile',
        text: 'Administracion',
        children: [
          { key: 'usuarios', href: 'usuarios.html', text: 'Usuarios' }
          // futuro: Roles y permisos
        ]
      }
    ]
  }
  ...
  return `
    <aside class="sidebar" aria-label="Primary navigation">
      <div class="sidebar-brand">
        ...
        <div class="brand-name">LiberCorp</div>
      </div>
  ...
  return `
    <header class="topbar">
      ...
      <div class="topbar-right">
        ...
        <button class="tb-btn tb-notifications" type="button" title="Alertas de red" aria-label="Alertas de red" aria-haspopup="dialog" aria-expanded="false">
          ...
          <span class="tb-alert-count" hidden></span>
        </button>
        <button class="tb-account" type="button" aria-label="Account menu" aria-haspopup="menu" aria-expanded="false">
          <span class="tb-account-info">
